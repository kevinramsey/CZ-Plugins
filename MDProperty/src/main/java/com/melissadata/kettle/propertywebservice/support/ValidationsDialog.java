...
public class ValidationsDialog extends MDAbstractDialog {
	...
	public ValidationsDialog(MDPropertyWebServiceDialog dialog) {
	...
	private String getString(String key) {
		...
		return BaseMessages.getString(PKG, "MDPropertyWebServiceDialog.ValidationDialog." + key);
	}
	...
	protected void createContents(Composite parent, Object data) {
		...
		helper = new MDPropertyWebServiceHelper((MDPropertyWebServiceDialog) dialog);
		// MDPropertyWebServiceMeta meta = ((MDPropertyWebServiceDialog) dialog).getStepMeta();
		// String message;
		Control last;
	...
	protected String getStringPrefix() {
		...
		return "MDPropertyWebServiceDialog.ValidationsDialog";
	}
