...
OutputBaseFilename={#MyAppName}-cloud-{#VERSION_NUM}_{#BUILD_NUM}
Compression=lzma
...
; master Reports
Source: "{#RESOURCES_DIR}\Reporting_Files\*.*"; DestDir: "{app}\ContactZone\mdKettle\MD\libext\reporting"; Flags: ignoreversion recursesubdirs createallsubdirs 
; JNDI property files
Source: "{#RESOURCES_DIR}\JNDI\cz.properties"; DestDir: "{app}\ContactZone\simple-jndi"; Flags: ignoreversion
Source: "{#RESOURCES_DIR}\JNDI\ga.properties"; DestDir: "{app}\ContactZone\simple-jndi"; Flags: ignoreversion
...
Source: "{#DATA_DIR}\Name\*.*"; DestDir: "{app}\Data"; Flags: ignoreversion; Permissions: users-modify
...
; MatchUp Files
Source: "{#MU_FILES_DIR}\*.*"; DestDir:"{app}\ContactZone\mdKettle\matchup"; Flags: ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
Source: "{#MUGLOBAL_FILES_DIR}\*.*"; DestDir:"{app}\ContactZone\mdKettle\matchup.global"; Flags: ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
...
Source:"{#NO_OVERRIDE_DIR}\MatchUp\mdMatchup*.mc"; DestDir: "{app}\ContactZone\mdKettle\matchup\"; Flags: onlyifdoesntexist; Permissions: users-modify
Source:"{#NO_OVERRIDE_DIR}\MatchUp\mdMatchup.cfg"; DestDir: "{app}\ContactZone\mdKettle\matchup\"; Flags: onlyifdoesntexist; Permissions: users-modify
Source:"{#NO_OVERRIDE_DIR}\MatchUpGlobal\mdMatchup*.mc"; DestDir: "{app}\ContactZone\mdKettle\matchup.global\"; Flags: onlyifdoesntexist; Permissions: users-modify
Source:"{#NO_OVERRIDE_DIR}\MatchUpGlobal\mdMatchup.cfg"; DestDir: "{app}\ContactZone\mdKettle\matchup.global\"; Flags: onlyifdoesntexist; Permissions: users-modify
Source:"{#NO_OVERRIDE_DIR}\Name\mdName.cfg"; DestDir: "{app}\Data\"; Flags: onlyifdoesntexist; Permissions: users-modify
