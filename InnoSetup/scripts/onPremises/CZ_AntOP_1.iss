...
OutputBaseFilename={#MyAppName}-OP-{#VERSION_NUM}_{#BUILD_NUM}
Compression=lzma
...
LicenseFile={#RESOURCES_DIR}\CZ_Specific\License.txt
InfoAfterFile={#RESOURCES_DIR}\CZ_Specific\PostInstallMessage.txt
WizardImageFile={#RESOURCES_DIR}\CZ_Specific\welcome-CZ-2017.bmp
WizardSmallImageFile={#RESOURCES_DIR}\CZ_Specific\logo-contact-zone-studio-update.bmp
SetupIconFile={#RESOURCES_DIR}\CZ_Specific\contact-zone-icon.ico
...
; Rules files
Source: "{src}\misc\rules\*"; DestDir: "{app}\ContactZone\mdKettle\MD\Rules"; Flags: external ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify

;Property files
Source: "{src}\misc\properties\mdProps.prop"; DestDir:"{app}\ContactZone\mdKettle"; Flags: external onlyifdoesntexist ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
Source: "{src}\misc\properties\mdProps.prop"; DestDir:"{app}\ContactZone\mdKettle\tmp"; Flags: external ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
...
;Report templates
Source: "{src}\misc\reports\*.*"; DestDir: "{app}\ContactZone\mdKettle\MD\libext\reporting"; Flags: external ignoreversion recursesubdirs createallsubdirs
...
;Matchup Files
Source: "{src}\Matchup\mdMatchup.dat";  DestDir: "{app}\ContactZone\mdKettle\matchup"; Flags: external ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
Source: "{src}\Matchup\MatchUpEditor.exe";  DestDir: "{app}\ContactZone\mdKettle\matchup"; Flags: external ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
Source: "{src}\misc\DLLs\64_bit\mdMatchUp.dll"; DestDir: "{app}\ContactZone\mdKettle\matchup"; Flags: external ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify

Source: "{src}\Matchup\Global\*.*"; DestDir: "{app}\ContactZone\mdKettle\matchup.global"; Flags: external ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
Source: "{src}\misc\DLLs\64_bit\mdMatchUp.dll"; DestDir: "{app}\ContactZone\mdKettle\matchup.global"; Flags: external ignoreversion recursesubdirs createallsubdirs; Permissions: users-modify
...
; Dlls
Source: "{src}\misc\DLLs\*"; DestDir: "{app}\ContactZone\mdKettle\MD"; Flags: external ignoreversion recursesubdirs createallsubdirs
...
Source:"{src}\Matchup\mdMatchup.mc"; DestDir: "{app}\ContactZone\mdKettle\matchup\"; Flags: external onlyifdoesntexist; Permissions: users-modify
Source:"{src}\Matchup\mdMatchup.cfg"; DestDir: "{app}\ContactZone\mdKettle\matchup\"; Flags: external onlyifdoesntexist; Permissions: users-modify

Source:"{src}\Matchup\Global\mdMatchup.mc"; DestDir: "{app}\ContactZone\mdKettle\matchup.global\"; Flags: external onlyifdoesntexist; Permissions: users-modify
Source:"{src}\Matchup\Global\mdMatchup.cfg"; DestDir: "{app}\ContactZone\mdKettle\matchup.global\"; Flags: external onlyifdoesntexist; Permissions: users-modify
