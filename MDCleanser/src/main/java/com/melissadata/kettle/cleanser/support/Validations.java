...
public class Validations {
	...
	private static File getVersionPropFile() {
		...
		String propertyPath = MDCleanserData.class.getProtectionDomain().getCodeSource().getLocation().getPath();
	...
	public void checkAddressInputFields(MDCleanserMeta meta, List<String> warnings, List<String> errors) {

		boolean chkOutput = false;
		String tabMarker = BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.InputTab.Marker", "");

// // check for duplicate input columns returns true if field is not empty
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ORGANIZATION).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.Organization"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ORGANIZATION).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE1).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AddressLine1"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE1).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE2).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AddressLine2"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE2).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE3).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AddressLine3"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE3).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE4).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AddressLine4"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE4).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE5).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AddressLine5"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE5).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE6).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AddressLine6"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE6).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE7).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AddressLine7"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE7).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE8).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AddressLine8"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE8).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_DOUBLE_DEPENDENT_LOCALITY).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.DoubleDependentLocality"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_DOUBLE_DEPENDENT_LOCALITY).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_DEPENDENT_LOCALITY).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.DependentLocality"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_DEPENDENT_LOCALITY).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_LOCALITY).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.Locality"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_LOCALITY).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_SUB_ADMINISTRATIVE_AREA).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.SubAdministrativeArea"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_SUB_ADMINISTRATIVE_AREA).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADMINISTRATIVE_AREA).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.AdministrativeArea"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADMINISTRATIVE_AREA).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_SUB_NATIONAL_AREA).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.SubNationalArea"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_SUB_NATIONAL_AREA).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_POSTAL_CODE).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.PostalCode"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_POSTAL_CODE).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_COUNTRY).metaValue))
// chkOutput = checkDuplicateInputFields(tabMarker + getTextName("InputTab.Country"),
// meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_COUNTRY).metaValue, warnings, errors);
...
// if(Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_ADDRESS_LINE1).metaValue)){
// chkOutput = false;
// warnings.add(tabMarker + BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.MissingInputAddressLine1"));
//
// }
// if(Const.isEmpty(meta.addrFields.inputFields.get(BusinessCoderFields.TAG_INPUT_COUNTRY).metaValue)
// && Const.isEmpty(meta.addrFields.defaultCountry)){
// chkOutput = false;
// warnings.add(tabMarker + BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.MissingInputCountry"));
// }
	...
	public void checkAddressOutputFields(MDCleanserMeta meta, List<String> warnings, List<String> errors) {

		boolean allEmpty = true;
		String tabMarker = BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.AddressTab.Marker", "");

// // check for at least one output column and check duplicate output columns
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ORGANIZATION).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.Organization"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ORGANIZATION).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE1).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressLine1"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE1).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE2).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressLine2"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE2).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE3).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressLine3"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE3).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE4).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressLine4"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE4).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE5).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressLine5"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE5).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE6).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressLine6"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE6).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE7).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressLine7"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE7).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE8).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressLine8"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_LINE8).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_LATITUDE).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.Latitude"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_LATITUDE).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_LONGITUDE).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.Longitude"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_LONGITUDE).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_TYPE).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.AddressType"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADDRESS_TYPE).metaValue, warnings, errors);
// if (!Const.isEmpty(meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_COUNTRY).metaValue))
// allEmpty = checkDuplicateOutputFields(tabMarker + getTextName("OutputTab.Country"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_COUNTRY).metaValue, warnings, errors);

		if (allEmpty) {
			warnings.add(tabMarker + BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.NoOutputFields",""));
		}

		// Additional address output only check for duplicates. ok if blank.
		tabMarker = BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.AdditionalOutputOptions.Marker","");

// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.Alpha2"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_COUNTRY_ISO_ALPHA2).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.Alpha3"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_COUNTRY_ISO_ALPHA3).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.Numeric"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_COUNTRY_NUMERIC).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.SubPremises"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_SUB_PREMISES).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.DoubleDependentLocality"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_DOUBLE_DEPENDENT_LOCALITY).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.DependentLocality"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_DEPENDENT_LOCALITY).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.Locality"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_LOCALITY).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.Building"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_BUILDING).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.PremisesType"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_PREMISES_TYPE).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.PremisesNumber"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_PREMISES_NUMBER).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.Thoroughfare"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_THOROUGHFARE).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.ThoroughfarePreDirection"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_PRE_DIRECTION).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.ThoroughfareLeadingType"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_LEADING_TYPE).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.ThoroughfareName"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_THOROUGHFARE_NAME).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.ThoroughfareTrailingType"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_TRAILING_TYPE).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.ThoroughfarePostDirection"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_POST_DIRECTION).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.PostBox"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_POSTBOX).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.SubAdminArea"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_SUB_ADMINISTRATIVE_AREA).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.AdminArea"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_ADMINISTRATIVE_AREA).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.PostalCode"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_POSTAL_CODE).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.SubNationalArea"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_SUB_NATIONAL_AREA).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.SubPremisesType"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_SUB_PREMISES_TYPE).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.SubPremisesNumber"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_SUB_PREMISES_NUMBER).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.DependentThoroughfare"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_DEPENDENT_THOROUGHFARE).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.DependentThoroughfarePreDirection"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_DEPENDENT_THOROUGHFARE_PRE_DIRECTION).metaValue, warnings,
// errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.DependentThoroughfareLeadingType"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_DEPENDENT_THOROUGHFARE_LEADING_TYPE).metaValue, warnings,
// errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.DependentThoroughfareName"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_DEPENDENT_THOROUGHFARE_NAME).metaValue, warnings, errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.DependentThoroughfareTrailingType"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_DEPENDENT_THOROUGHFARE_TRAILING_TYPE).metaValue, warnings,
// errors);
// checkDuplicateOutputFields(tabMarker + getTextName("AdditionalOutputDialog.DependentThoroughfarePostDirection"),
// meta.addrFields.outputFields.get(BusinessCoderFields.TAG_OUTPUT_DEPENDENT_THOROUGHFARE_POST_DIRECTION).metaValue,
// warnings, errors);

	}

	// check filter rule order and target
	public void checkFilterOrder(MDCleanserMeta meta, List<String> warnings, List<String> errors) {
	...
	public void checkInitialization(MDCleanserMeta meta) {
 ...
 */
	...
	// check email output
	public void checkReportingOutputFields(MDCleanserMeta meta, List<String> warnings, List<String> errors) {

/*
 * if(isReportEnabled(meta)){
 * String tabMarker = BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.ReportingTab.Marker");
 ...
 * errors.add(tabMarker + BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.MissingDirPath"));
 * }
 ...
 * warnings.add(tabMarker + BaseMessages.getString(PKG, "MDBusinessCoderDialog.Validation.ReportSetName"));
 * }
 ...
 */
	...
	public void validate(MDCleanserMeta meta, List<String> warnings, List<String> errors) {
