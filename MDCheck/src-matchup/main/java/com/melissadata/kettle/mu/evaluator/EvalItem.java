...
public class EvalItem implements Cloneable{
	...
	public EvalItem(int intVal) {
		this.type = eTypes.Constant;
		this.value = intVal;
		this.dataType = eDataType.DT_INT;
	}

	public EvalItem(double dblVal) {
		this.type = eTypes.Constant;
		this.value = dblVal;
		this.dataType = eDataType.DT_DOUBLE;
	}
	...
	public EvalItem(String strVal) {
		this.type = eTypes.Constant;
		this.value = strVal;
		this.dataType = eDataType.DT_STRING;
	}
	...
	private eDataType typeFromVmi(int vmiType) {
		...
		switch (vmiType) {
		case 1:
			return eDataType.DT_DOUBLE;
		case 2:
			return eDataType.DT_STRING;
		case 3:
	...
	public boolean isNull() {
		// FIXME MostComplete  is null should this count empty string as null ?
		//System.out.println(" Testing value -- " + value + "   is null = " + (value == null));
		if (value == null)
			return true;
		else
			return false;
	...
	public boolean isInt() {
		return (dataType == eDataType.DT_INT);
	}
	...
	public boolean isDouble() {
		return (dataType == eDataType.DT_DOUBLE);
	}
	...
	public boolean isString() {
		return (dataType == eDataType.DT_STRING);
	}
