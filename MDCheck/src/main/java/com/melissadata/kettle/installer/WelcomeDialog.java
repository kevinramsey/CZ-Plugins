...
public class WelcomeDialog extends MDAbstractDialog {
	...
	public boolean cancel() {
		MDCheckDialog.continueToAdvancedConfig = false;
		dispose();
		return true;
	}
	...
	@Override
	public void ok() {
		MDCheckDialog.licString = wLicense.getText();
		MDCheckDialog.continueToAdvancedConfig = true;
		dispose();
	}
	...
	protected void createContents(Composite parent, Object arg1) {
		...
		logo.setImage(ImageUtil.getImage(display, this.getClass(), "com/melissadata/kettle/images/MelissaData.gif"));
		helper.setLook(logo);
