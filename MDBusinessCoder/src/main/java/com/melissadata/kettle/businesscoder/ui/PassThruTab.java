...
public class PassThruTab implements MDTab {
	...
	protected MDBusinessCoderDialog	dialog;
	...
	public PassThruTab(MDBusinessCoderDialog dialog, TransMeta transMeta) {
	...
	public String getHelpURLKey() {
		return BaseMessages.getString(PKG, "MDBusinessCoder.Plugin.Help.PassThroughTab");
	}
...
// column.setMoveable(true);
	...
	protected String getString(String key, String... args) {
		...
		return BaseMessages.getString(PKG, "MDBusinessCoderDialog.PassThruTab." + key, args);
	}
