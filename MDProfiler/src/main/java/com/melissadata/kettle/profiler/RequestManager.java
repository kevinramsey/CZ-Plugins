...
public class RequestManager implements IRequestManager {
	public class Request {
		private MDProfilerService				service;
		private ArrayList<MDProfilerRequest>	requests;
		private int								queue;
		private KettleException					exception;

		public Request(MDProfilerService service, List<MDProfilerRequest> requests, int queue) {
			this.service = service;
			this.requests = new ArrayList<MDProfilerRequest>(requests);
			this.queue = queue;
		}
		...
		public List<MDProfilerRequest> getRequests() {
			return requests;
		}
		...
		public void run() {
			...
			try {
				...
				service.processRequests(requests, queue);
				...
				// Wrap the exception
				exception = new KettleException(MDProfilerStep.getErrorString("RequestFailed"), t);
			}
		}
	}
	...
	@Override
	public void addRequest(MDProfilerService service, List<MDProfilerRequest> requests, int queue) {
