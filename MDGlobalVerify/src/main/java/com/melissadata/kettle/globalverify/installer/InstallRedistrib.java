...
public class InstallRedistrib extends MDAbstractDialog {
	...
	private void doInstall(String bitSz) {
		...
		try {
			...
			dialog.getLog().logError("Error Installing Redistribs:" + e.getMessage());
		}
	}
	...
	private String getSrcDir() {
		...
		try {
			...
			dialog.getLog().logError("Error Installing VC++ Redistributables: " + e.getMessage());
		}
		return decodedPath;
	}
	...
	protected String getStringPrefix() {
		return "MDGlobalAddressDialog.RedisInstaller";
	}
