...
public class PassThruFields {
	...
	/**
	 * Called during processing before the first row. It will lookup the index of the pass thru fields and detect any
	 * problems.
	 *
	 * @param ioMeta
	 *
	 * @return
	 */
	public boolean selectIndexes(MDGlobalVerify step, MDGlobalData data, IOMetaHandler ioMeta) {
