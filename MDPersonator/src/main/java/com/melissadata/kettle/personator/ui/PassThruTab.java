...
import com.melissadata.kettle.personator.data.PassThruFields;
import com.melissadata.kettle.personator.support.MDPersonatorHelper;
import com.melissadata.kettle.personator.support.MDPersonatorTransfer;
...
public abstract class PassThruTab implements MDTab {
	...
	protected MDPersonatorDialog dialog;
	...
	public PassThruTab(MDPersonatorDialog dialog, TransMeta transMeta) {
		this.dialog = dialog;
	...
	private TableViewer createTable(Composite parent) {
		...
		helper.setLook(table, PropsUI.WIDGET_STYLE_TABLE);
	...
	private void addDND(final TableViewer viewer, final String id) {
		...
		final MDPersonatorTransfer myTransfer = MDPersonatorTransfer.getInstance();
...
//					System.out.println("dragSetData.1:");
					...
					MDPersonatorTransfer.Type datum = new MDPersonatorTransfer.Type();
					datum.setID(id);
...
//						System.out.println("dragEnter.3:");
						...
						MDPersonatorTransfer.Type datum = (MDPersonatorTransfer.Type) myTransfer.nativeToJava(event.currentDataType);
						if (datum != null) {
...
//					System.out.println("drop.1:");
					...
					int added = 0;
					MDPersonatorTransfer.Type datum = (MDPersonatorTransfer.Type) event.data;
					if (datum != null) {
...
//							System.out.println("drop.2:: event.detail=" + event.detail);
	...
	protected void getFields() {
		...
		if (passThru.size() != 0 || filterOut.size() != 0) {
			MessageDialog md = new MessageDialog(dialog.getShell(),
					getString("GetFields.Title"), //$NON-NLS-1$
					null, 
					getString("GetFields.Message"), //$NON-NLS-1$  
					MessageDialog.WARNING, 
					new String[] { 
						getString("GetFields.AddNew"), //$NON-NLS-1$  
...
//		column.setMoveable(true);
	...
	protected String getString(String key, String... args) {
		return BaseMessages.getString(PKG, "MDPersonatorDialog.PassThruTab." + key, args);
	}
...
//			return "MDPersonatorDialog.Help.PassThruTab";
//		else
		return BaseMessages.getString(PKG,"MDPersonatorDialog.Plugin.Help.PassThruTab");
	}
