...
/*)*/   {eStackOperations.Error,    eStackOperations.Error,    eStackOperations.Error,    eStackOperations.Error,    eStackOperations.Error}
	...
	private void stringToStack(String expression) throws KettleException {
		...
		for (int i = 0; i < tokens.length; i++) {
            ...
            //   a syntax error):
            if (thisToken == eTokenType.ResultCode &&
                (lastToken.isOneOf(eTokenType.ResultCode, eTokenType.RightParenthesis) ||
                nextToken.isOneOf(eTokenType.ResultCode, eTokenType.LeftParenthesis)))
            	throw new EvaluatorException("SyntaxErrorInExpression", expression);
            else if (thisToken.isOneOf(eTokenType.And, eTokenType.Or) &&
                     (lastToken.isOneOf(eTokenType.BeginningOfExpression, eTokenType.And, eTokenType.Or, eTokenType.Not, eTokenType.LeftParenthesis) ||
                     nextToken.isOneOf(eTokenType.EndOfExpression, eTokenType.And, eTokenType.Or, eTokenType.RightParenthesis)))
            	throw new EvaluatorException("SyntaxErrorInExpression", expression);
            else if (thisToken == eTokenType.Not &&
            		 (lastToken.isOneOf(eTokenType.ResultCode, eTokenType.RightParenthesis) ||
            		 nextToken.isOneOf(eTokenType.EndOfExpression, eTokenType.And, eTokenType.Or, eTokenType.RightParenthesis)))
            	throw new EvaluatorException("SyntaxErrorInExpression", expression);
            else if (thisToken == eTokenType.LeftParenthesis &&
                     (lastToken.isOneOf(eTokenType.ResultCode, eTokenType.RightParenthesis) ||
                     nextToken.isOneOf(eTokenType.EndOfExpression, eTokenType.And, eTokenType.Or, eTokenType.RightParenthesis)))
            	throw new EvaluatorException("SyntaxErrorInExpression", expression);
            else if (thisToken == eTokenType.RightParenthesis &&
                     (lastToken.isOneOf(eTokenType.BeginningOfExpression, eTokenType.And, eTokenType.Or, eTokenType.Not, eTokenType.LeftParenthesis) ||
                     nextToken.isOneOf(eTokenType.ResultCode, eTokenType.Not, eTokenType.LeftParenthesis)))
            	throw new EvaluatorException("SyntaxErrorInExpression", expression);
